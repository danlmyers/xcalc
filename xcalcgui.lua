...
function xcalc_windowframe()
    ...
    backspacebutton:SetScript("OnClick", function() xcalc_buttoninput("BS") end)
    --CE button
    ...
    cebutton:SetText("CE")
    cebutton:SetScript("OnClick", function() xcalc_buttoninput("CE") end)
    --Clear Button
    ...
    cbutton:SetText("C")
    cbutton:SetScript("OnClick", function() xcalc_buttoninput("CL") end)
    --Equals Button
    ...
    equalbutton:SetText("=")
    equalbutton:SetScript("OnClick", function() xcalc_buttoninput("=") end)
    --Exp Button
    ...
    expbutton:SetText("^")
    expbutton:SetScript("OnClick", function() xcalc_buttoninput("^") end)
    --Plus Minus Button
    ...
    plusbutton:SetText("+")
    plusbutton:SetScript("OnClick", function() xcalc_buttoninput("+") end)
    --Minus Button
    ...
    minusbutton:SetText("-")
    minusbutton:SetScript("OnClick", function() xcalc_buttoninput("-") end)
    --Multiply Button
    ...
    multiplybutton:SetScript("OnClick", function() xcalc_buttoninput("*") end)
    --Divide Button
    ...
    dividebutton:SetScript("OnClick", function() xcalc_buttoninput("/") end)
    --Copper Button
    ...
    copperbutton:SetScript("OnClick", function() xcalc_buttoninput("COPPER") end)
    --Silver Button
    ...
    silverbutton:SetScript("OnClick", function() xcalc_buttoninput("SILVER") end)
    --Gold Button
    ...
    goldbutton:SetScript("OnClick", function() xcalc_buttoninput("GOLD") end)
    --Decimal Button
    ...
    decimalbutton:SetScript("OnClick", function() xcalc_buttoninput(".") end)
    --0 button
    ...
    zerobutton:SetScript("OnClick", function() xcalc_buttoninput("0") end)
    --3 button
    ...
    threebutton:SetScript("OnClick", function() xcalc_buttoninput("3") end)
    --2 Button
    ...
    twobutton:SetText("2")
    twobutton:SetScript("OnClick", function() xcalc_buttoninput("2") end)
    --1 Button
    ...
    onebutton:SetText("1")
    onebutton:SetScript("OnClick", function() xcalc_buttoninput("1") end)
    --6 Button
    ...
    sixbutton:SetText("6")
    sixbutton:SetScript("OnClick", function() xcalc_buttoninput("6") end)
    --5 Button
    ...
    fivebutton:SetScript("OnClick", function() xcalc_buttoninput("5") end)
    --4 Button
    ...
    fourbutton:SetScript("OnClick", function() xcalc_buttoninput("4") end)
    --9 Button
    ...
    ninebutton:SetScript("OnClick", function() xcalc_buttoninput("9") end)
    --8 Button
    ...
    eightbutton:SetScript("OnClick", function() xcalc_buttoninput("8") end)
    --7 Button
    ...
    sevenbutton:SetScript("OnClick", function() xcalc_buttoninput("7") end)
    --Memory Add Button
    ...
    mabutton:SetText("MA")
    mabutton:SetScript("OnClick", function() xcalc_buttoninput("MA") end)
    --Memory Store Button
    ...
    msbutton:SetText("MS")
    msbutton:SetScript("OnClick", function() xcalc_buttoninput("MS") end)
